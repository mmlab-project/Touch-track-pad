...
> [!NOTE]
> デモGIFやスクリーンショットは今後追加予定です。以下のような画面が表示されます：
> - QRコード接続画面
> - トラックパッド操作画面
> - キーボード入力画面
> - マクロ実行画面
...
この記事を読んでる皆さんはパソコンを使って作業を行う方だと思います。  
パソコンにもノートパソコンやデスクトップと色々ありますが、特にデスクトップの方はマウスを使ってらっしゃると思います。ノートパソコンもマウスを使ったほうが便利だったりしますよね。

#### 🖱️ マウスについて

マウスって色々ありますよね。形も様々だし、サイドボタンが多かったり、トラックボールで操作してマウス自体を動かさないやつとかもあります。

そんな中、**トラックパッドってめちゃ便利じゃないですか？**

Macのトラックパッドが一番機能が多いと思いますが、ノートパソコンのトラックパッドも革新的だと思います。マウスだと物理ボタンの数しか基本的には機能がありませんが、トラックパッドは**指の数とその動作で機能が増える**んです。

例えば指1本でタップとドラッグができます。1本で2つの動作ができるんです。そしてデバイス自体を動かさないので直感的に操作できます。その時点でマウスよりも遥かに便利なデバイスだと思っています。

ですが、それ故にトラックパッドはAppleのMagic Trackpadなど**本体がめちゃ高い**です。そんなところからこのプロジェクトは始まりました。**安くトラックパッドを使いたい**って感じです。

#### 💭 アイデアの誕生

最初はスマホなんて検討もついてませんでした。本当は2010年に登場したMac用のMagic Trackpadを使用するつもりでしたが、昔すぎて現在のWindowsで利用するのはめちゃくちゃめんどくさそうってなって、「できたらいいなー」で終わっていました。

ある時、パソコンで作業してるとき横のほうに放ってあるスマホを見て「通知全然気づかなかったなー、もっとすぐ分かればいいのに、パソコン使いながらスマホ使うなんて器用なことできないなー」なんて思っていたら、トラックパッドのことを思い出しました。

#### 🤖 AI時代の開発

今はVibe CodingというAIにコードを書いてもらっても割とアプリは完成するんですよね。すごい時代だなと思います。早速AIに指示して試行錯誤を続けた結果、この形に落ち着きました。

**スマホをトラックパッドとして使えるかつ、キーボード、マクロ機能あり。**

このアプリのいいところは**マウスが不必要**なことです。もっと言うならキーボード、ショートカットボタンは最悪必要ないです。ワイヤレスマウスの充電忘れ等の心配もスマホを充電しとけばいいだけなので、使えないってなることも少ないですし、スリムで携帯しやすいなと思います。

複数の指でいろいろな操作ができるので、マウスより場合によっては便利と思います。マクロ機能も追加したのでスクリーンショット等もワンタッチでできて、ショートカットを多用する方にもおすすめです。

まだまだ改善する箇所はいろいろ見つかってくると思いますので、**実際に試して評価してくれたらうれしいです！**
