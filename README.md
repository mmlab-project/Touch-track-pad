...
- **🚀 緊急時の対応**: 外出先でマウスやキーボードがない時の緊急対応
- **🎤 プレゼンテーション**: プレゼンテーション時のリモートコントロール
- **⚡ 効率化**: 複雑な操作をマクロ化して作業効率を大幅向上
- **🔌 簡単接続**: QRコード接続による面倒な設定の排除
...
- **マルチタッチジェスチャー対応**:
  - 1本指: カーソル移動、タップでクリック
  - 2本指: スクロール、ピンチイン/アウト、回転、水平スワイプ
  - 3本指: ピンチイン/アウト
  - 4本指: 垂直/水平スワイプ
- **感度調整**: マウス感度とスクロール感度を個別に調整可能
- **ナチュラルスクロール**: macOS風のスクロール方向に対応
...
| 2本指横スクロール | 左右スクロール | 横長コンテンツ |
| 2本指ピンチイン | ズームアウト | 地図、画像を縮小 |
| 2本指ピンチアウト | ズームイン | 地図、画像を拡大 |
| 2本指回転 | 回転操作 | 画像編集など |
...
| ------------ | ---- | -------------- | ---- |
| 2本指水平スワイプ左 | ブラウザ「戻る」 | Alt + ← | ページ履歴を戻る |
| 2本指水平スワイプ右 | ブラウザ「進む」 | Alt + → | ページ履歴を進む |
| 3本指ピンチイン | タスクビュー | Win + Tab | 開いているウィンドウ一覧 |
| 3本指ピンチアウト | デスクトップ表示 | Win + D | 全ウィンドウを最小化 |
| 4本指上スワイプ | 仮想デスクトップ上 | Ctrl + Win + → | 次のデスクトップへ |
| 4本指下スワイプ | 仮想デスクトップ下 | Ctrl + Win + ← | 前のデスクトップへ |
| 4本指左スワイプ | アプリ切り替え | Alt + Tab | 次のアプリへ |
| 4本指右スワイプ | アプリ切り替え | Alt + Shift + Tab | 前のアプリへ |
